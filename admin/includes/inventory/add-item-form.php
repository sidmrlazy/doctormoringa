<div class="container section-wrapper">
    ...
    <form class="card p-5" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-floating w-100 mb-3">
            <textarea maxlength="600" class="form-control" type="text" name="item_description"
                placeholder="Add Category Description" id="floatingTextarea2" style="height: 100px"></textarea>
            <label for="floatingTextarea2">Description</label>
            <div class="mt-2">Max Character Limit: 600</div>
        </div>
        ...
        <div class="form-floating w-100 mb-3">
            <textarea maxlength="600" class="form-control" type="text" name="item_benefits"
                placeholder="Add Category Description" id="floatingTextarea2" style="height: 100px"></textarea>
        ...
        <div class="form-floating w-100 mb-3">
            <textarea maxlength="600" class="form-control" type="text" name="item_usage"
                placeholder="Add Category Description" id="floatingTextarea2" style="height: 100px"></textarea>
