        ...
        <form class="single-input-form" method="POST" enctype="multipart/form-data">
            ...
            ?>
                    ...
                    <div class="form-floating mb-3 w-100">
                        <input type="text" name="item_id" hidden class="form-control" value="<?php echo $item_id; ?>" id="floatingInput" placeholder="<?php echo $item_id; ?>">
                        <input type="text" name="item_name" class="form-control" value="<?php echo $item_name; ?>" id="floatingInput" placeholder="<?php echo $item_name; ?>">
                        <label for="floatingInput">Product Name</label>
                    </div>


                    <div class="form-floating mb-3 w-100">
                        <input type="text" name="item_weight" value="<?php echo $item_weight; ?>" class="form-control" id="floatingInput" placeholder="<?php echo $item_weight; ?>">
                        <label for="floatingInput">Product Weight</label>
                    </div>

                    <div class="form-floating mb-3 w-100">
                        <input type="text" name="item_description" class="form-control" value="<?php echo $item_description; ?>" id="floatingInput" placeholder="<?php echo $item_description; ?>" style="height: 100px">
                        <label for="floatingInput">Product Description</label>
                    </div>

                    <div class="form-floating mb-3 w-100">
                        <input type="text" name="item_ingredients" class="form-control" value="<?php echo $item_ingredients; ?>" id="floatingInput" placeholder="<?php echo $item_ingredients; ?>" style="height: 100px">
                        <label for="floatingInput">Product Ingredients</label>
                    </div>

                    <div class="form-floating w-100 mb-3">
                        <input type="text" name="item_benefits" class="form-control" value="<?php echo $item_benefits; ?>" id="floatingInput" placeholder="<?php echo $item_benefits; ?>" style="height: 100px;">
                        <label for="floatingInput">Benefits</label>
                    </div>

                    <div class="form-floating w-100 mb-3">
                        <input type="text" name="item_usage" class="form-control" value="<?php echo $item_usage; ?>" id="floatingInput" placeholder="<?php echo $item_usage; ?>" style="height: 100px;">
                        <label for="floatingInput">Usage</label>
                    </div>

                    <div class="form-floating w-100 mb-3">
                        <input type="text" name="item_price" class="form-control" value="<?php echo $item_price; ?>" id="floatingInput" placeholder="₹<?php echo $item_price; ?>">
                        <label for="floatingInput">Price</label>
                    </div>


                    <div class="form-floating w-100">
                        <select class="form-select" id="floatingSelect" name="item_category" aria-label="Floating label select example">
                    ...
                    <div class="edit-form-btn-section">
                        <button type="submit" name="update" value="update" class="btn btn-primary custom-form-button">Update</button>

                        <button type="submit" name="delete" value="delete" class="btn btn-primary delete-button-edit">Delete</button>
                    </div>
            <?php
                }
            }
