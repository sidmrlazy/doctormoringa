        ...
        if ($product_price >0) { ?>
            ...
            <div class="col-md-6 m-1 pricing-tab">
                ...
                <div class="inner-headings">
                    ...
                    <div class="user-details">
                        <p id="user-details-heading">Contact</p>
                         <input required type="text" name="user_contact" value="<?php echo $user_contact; ?> " >
                    </div>
                </div>
                <div class="inner-headings">
                ...
                <div class="user-details">
                    ...
                    <input required type="text" name="user_state" value="<?php echo $user_state; ?> " >
                </div>

                <div class="user-details">
                    <p id="user-details-heading">City</p>
                    <input  required type="text" name="user_city" value="<?php echo $user_city; ?> " >
                </div>
            </div>
                <div class="inner-headings">
                ...
                <div class="user-details">
                    ...
                    <input required type="text" name="user_address" value="<?php echo $user_address; ?> " >
                </div>

                <div class="user-details">
                    <p id="user-details-heading">Email-id</p>
                    <input required type="text" name="user_email" value="<?php echo $user_email; ?> " >
                </div>
            ...
            <div class="col-md-6 m-1 pricing-tab">
                ...
                <div class="inner-headings">
                    ...
                    <p><?php
                    $delivery_chearge = 60; echo $delivery_chearge;?></p>
                </div>

                <div class="inner-headings">
                    <p id="heading">Grand Total</p>
                    <p><?php
                    $gross_total = $all_total_price+$delivery_chearge; echo $gross_total;?></p>
                </div>
                ...
                <input   type=" " name="" class="checkout-btn" value='Proceed to Checkout' />
            </div>
        </div>
       <?php }else{
