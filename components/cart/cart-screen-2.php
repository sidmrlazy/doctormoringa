            ...
            <div class="final-section mt-4">
                <div class="col-md-6 m-1 pricing-tab">
                    ...
                    <div class="inner-headings">
                        <div class="form-floating m-1 user-details">
                            <input required class="form-control" placeholder="Full Name" type="text" minlength="2" id="floatingInput" name="user_name" value="<?php echo $user_name; ?>">
                            <label for="floatingInput">Customer Name</label>
                        </div>

                        <div class="form-floating m-1 user-details">
                            <input required class="form-control" placeholder="+91 XXXXX XXXXX" type="number" minlength="10" id="floatingInput" name="user_contact" value="<?php echo $user_contact; ?>">
                    ...
                    <div class="inner-headings">
                        <div class="form-floating m-1 user-details">
                            <input required class="form-control" placeholder="State" type="text" minlength="2" id="floatingInput" name="user_state" value="<?php echo $user_state; ?>">
                            <label for="floatingInput">State</label>
                        </div>


                        <div class="form-floating m-1 user-details">
                            <input required class="form-control" placeholder="City" type="text" minlength="2" id="floatingInput" name="user_city" value="<?php echo $user_city; ?>">
                    ...
                    <div class="inner-headings">
                        <div class="form-floating m-1 user-details">
                            <input required class="form-control" placeholder="State" type="text" minlength="2" id="floatingInput" name="user_address" value="<?php echo $user_address; ?>">
                            <label for="floatingInput">Address</label>
                        </div>

                        <div class="form-floating m-1 user-details">
                            <input required class="form-control" placeholder="Email" type="email" minlength="2" id="floatingInput" name="user_email" value="<?php echo $user_email; ?>">
                ...
                <div class="col-md-6 m-1 pricing-tab">
                    ...
                    <div class="inner-headings">
                        ...
                        <input hidden type="text" minlength="5" name="delivery_chearge" value="<?php echo $delivery_chearge; ?>">
